...
**Coverage is now effectively 100% of the PDF's frequency-ranked list (all 20 ranked topics addressed), plus 2 extra DBATU-common topics (Type Checking, Ambiguous Grammar) not in the PDF's list but still worth knowing.** This 30-question set is your complete, gap-free revision bank for BTCOC601. Let me know if you'd like the cheat sheet updated with Q21–Q30 as well.
